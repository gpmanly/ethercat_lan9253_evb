...
#include "weather.h"
#define _ETHERCAT_LAN9253_SLAVE_ 1
#include "ethercat_lan9253_slave.h"
#undef _ETHERCAT_LAN9253_SLAVE_
/*--------------------------------------------------------------------------------------
------
...
void APPL_InputMapping(UINT16* pData)
{
    ...
    *pTemp = Inputs0x6000.SensorAnalog;
    pTemp++;
    *pTemp = Inputs0x6000.Temperature;
    pTemp++;
    *pTemp = Inputs0x6000.Pressure;
    pTemp++;
    *pTemp = Inputs0x6000.Humidity;
}
...
{
    UINT32 *pTemp = (UINT32*)pData;
    Outputs0x7010.DigioOut = *pTemp;
    pTemp++;
    Outputs0x7010.Servo = *pTemp;
}
